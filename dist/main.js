...
var previewModalCloseButton = _components_Card_js__WEBPACK_IMPORTED_MODULE_3__.previewModal.querySelector(".modal__close-button"); // Form data
...
function editFormSubmitHandler(event) {
  ...
  (0,_components_utils_js__WEBPACK_IMPORTED_MODULE_2__.closeModal)(editModal);
...
function addFormSubmitHandler(event) {
  ...
  var cardEl = new _components_Card_js__WEBPACK_IMPORTED_MODULE_3__["default"](card, "#cardTemplate").generateCard();
  cards.prepend(cardEl);
  (0,_components_utils_js__WEBPACK_IMPORTED_MODULE_2__.closeModal)(addModal);
...
addModalCloseButton.addEventListener("click", function () {
  return (0,_components_utils_js__WEBPACK_IMPORTED_MODULE_2__.closeModal)(addModal);
});
previewModalCloseButton.addEventListener("click", function () {
  return (0,_components_utils_js__WEBPACK_IMPORTED_MODULE_2__.closeModal)(_components_Card_js__WEBPACK_IMPORTED_MODULE_3__.previewModal);
}); // Actions

_components_data_js__WEBPACK_IMPORTED_MODULE_1__["default"].forEach(function (card) {
  var cardEl = new _components_Card_js__WEBPACK_IMPORTED_MODULE_3__["default"](card, "#cardTemplate").generateCard();
  cards.append(cardEl);
}); // Validation
...
var addFormValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_4__["default"](validationSettings, addFormEl);
addFormValidator.enableValidation();
var editFormValidator = new _components_FormValidator_js__WEBPACK_IMPORTED_MODULE_4__["default"](validationSettings, editFormEl);
